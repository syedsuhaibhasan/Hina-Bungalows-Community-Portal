 ...
 * @author Sohaib Hasan
 */
public class viewMonthlyExpense extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(viewMonthlyExpense.class.getName());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            con = ConnectionProvider.getcon();
            ps = con.prepareStatement("SELECT * FROM maintenanceBreakdown WHERE month = ? AND year = ?");
            ps.setString(1, this.month);
            ...
            if (rs.next()) {
                ...
                JOptionPane.showMessageDialog(this, "No data found for " + month + " " + year);
            }
        } catch (SQLException ex) {
    ...
    public static void main(String args[]) {
        ...
        viewMonthlyExpense frame = new viewMonthlyExpense(); // constructor builds UI (initComponents)
